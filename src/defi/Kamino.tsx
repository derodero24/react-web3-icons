...
export const Kamino = /* @__PURE__ */ createIcon(
  ...
  () => (
    <>
      ...
      <path d="M230.411 124H170V416.11H230.411V124Z" fill="#CAF2FC" />
      <path
        d="M374.819 412.464C344.558 391.602 324.114 352.799 324.114 308.331C324.114 263.862 344.558 225.059 374.819 204.197V200.684H291.108C271.52 231.032 259.815 268.144 259.815 308.331C259.815 348.517 271.498 385.607 291.108 415.978H374.819V412.464Z"
        fill="#CAF2FC"
      />
    </>
  ),
    ...
    <>
      ...
      <defs>
        <mask id={`${_id}-kamino-a`}>
          ...
          <path d="M230.411 124H170V416.11H230.411V124Z" fill="#000" />
          <path
            d="M374.819 412.464C344.558 391.602 324.114 352.799 324.114 308.331C324.114 263.862 344.558 225.059 374.819 204.197V200.684H291.108C271.52 231.032 259.815 268.144 259.815 308.331C259.815 348.517 271.498 385.607 291.108 415.978H374.819V412.464Z"
            fill="#000"
          />
