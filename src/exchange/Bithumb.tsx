...
export const BithumbMono = createIcon(
  ...
  () => (
    <>
      <path d="M6.007 7.287h2.562L6.577 12.16s-1.042-.017-1.36-.927a1.44 1.44 0 0 1-.022-.835z" />
      <path d="m15.944 7.391-3.258-.057.733-2.418A1.483 1.483 0 0 0 12.005 3H9.03l-3.4 12.21s-1.218 5.222 3.4 5.695c0 0 7.3 1.492 9.643-7.329 0 0 1.236-5.335-2.73-6.185m-2.227 6.056s-.13 2.253-1.83 2.648a1.1 1.1 0 0 1-.75-.077c-.266-.136-.54-.418-.534-1.01q.006-.256.082-.504l.627-2.344h1.714s.776.252.691 1.287" />
