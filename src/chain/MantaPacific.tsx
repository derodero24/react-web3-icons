...
/** MantaPacific chain icon (monochrome). */
export const MantaPacificMono = createIcon(
  'MantaPacificMono',
  '0 0 24 24',
  () => <path fillRule="evenodd" d={mantaPacificPath} clipRule="evenodd" />,
  'currentColor',
);
