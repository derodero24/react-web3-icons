...
export const InkMono = /* @__PURE__ */ createIcon(
  'InkMono',
  '0 0 24 24',
  () => <path d={INK_PATH} fillRule="evenodd" clipRule="evenodd" />,
  'currentColor',
);
