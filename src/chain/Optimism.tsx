...
export const Optimism = /* @__PURE__ */ createIcon(
  ...
  () => (
    <>
      ...
      <path
        d="M14 26.25v-5.185c5.333 0 9.658-4.324 9.658-9.657S19.333 1.75 14 1.75v5.185c-5.333 0-9.658 4.324-9.658 9.657S8.667 26.25 14 26.25Zm4.778-12.205v-.09c-2.106-1.049-3.684-2.627-4.733-4.733h-.09c-1.049 2.106-2.627 3.684-4.733 4.733v.09c2.106 1.049 3.684 2.627 4.733 4.733h.09c1.049-2.106 2.627-3.684 4.733-4.733Z"
        fill="#fff"
      />
    </>
  ),
...
export const OptimismCircle = /* @__PURE__ */ createIcon(
  ...
  () => (
    <>
      ...
      <g transform="translate(9 9) scale(1.643)">
        <path
          d="M14 26.25v-5.185c5.333 0 9.658-4.324 9.658-9.657S19.333 1.75 14 1.75v5.185c-5.333 0-9.658 4.324-9.658 9.657S8.667 26.25 14 26.25Zm4.778-12.205v-.09c-2.106-1.049-3.684-2.627-4.733-4.733h-.09c-1.049 2.106-2.627 3.684-4.733 4.733v.09c2.106 1.049 3.684 2.627 4.733 4.733h.09c1.049-2.106 2.627-3.684 4.733-4.733Z"
          fill="#fff"
        />
  ...
  _id => (
    <>
      ...
      <defs>
        <mask id={`${_id}-opts-a`}>
          <rect width="100%" height="100%" fill="#fff" />
          <g transform="translate(9 9) scale(1.643)" fill="#000">
            <path d="M14 26.25v-5.185c5.333 0 9.658-4.324 9.658-9.657S19.333 1.75 14 1.75v5.185c-5.333 0-9.658 4.324-9.658 9.657S8.667 26.25 14 26.25Zm4.778-12.205v-.09c-2.106-1.049-3.684-2.627-4.733-4.733h-.09c-1.049 2.106-2.627 3.684-4.733 4.733v.09c2.106 1.049 3.684 2.627 4.733 4.733h.09c1.049-2.106 2.627-3.684 4.733-4.733Z" />
          </g>
        </mask>
      </defs>
    </>
