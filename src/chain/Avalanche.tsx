  ...
  function Avalanche({ withBackground = true, ...rawProps }, ref) {
    ...
    return (
      ...
      >
        ...
        <path fillRule="evenodd" d={AVALANCHE_PATH} />
      </svg>
    );
  },
);

export const Avalanche2 = createIcon(
  'Avalanche2',
  '320 280 869 771',
  _id => (
    <>
      <defs>
        <mask id={`${_id}-avl2-a`}>
          ...
          <path fillRule="evenodd" d={AVALANCHE_PATH} fill="#000" />
        </mask>
      </defs>
      <path d="M287 258h928v844H287z" mask={`url(#${_id}-avl2-a)`} />
    </>
  ),
  '#e84142',
);
...
export const AvalancheMono2 = createIcon(
  'AvalancheMono2',
  '320 280 869 771',
  _id => (
    <>
