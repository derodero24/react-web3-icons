...
function AvalancheBase2(props: IconProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="320 280 869 771"
      width="1em"
      height="1em"
      {...props}
    >
      ...
      <path d="M287 258h928v844H287z" mask="url(#avl2-a)" />
    </svg>
  );
}
...
export function Avalanche2(props: IconProps) {
  return <AvalancheBase2 fill="#e84142" {...props} />;
}
...
export function AvalancheMono2(props: IconProps) {
  return <AvalancheBase2 fill="currentColor" {...props} />;
}
