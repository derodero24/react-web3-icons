...
const ARBNOVA_CIRCLE2 =
  'M750 274c64.29 0 126.62 12.57 185.26 37.38 56.67 23.97 107.59 58.3 151.32 102.04 43.74 43.74 78.07 94.65 102.04 151.32C1213.42 623.38 1226 685.71 1226 750s-12.57 126.62-37.38 185.26c-23.97 56.67-58.3 107.59-102.04 151.33s-94.65 78.07-151.32 102.04c-58.64 24.8-120.97 37.38-185.26 37.38s-126.62-12.58-185.26-37.38c-56.67-23.97-107.59-58.3-151.32-102.04-43.74-43.74-78.07-94.65-102.04-151.33C286.58 876.62 274 814.29 274 750s12.57-126.62 37.38-185.26c23.97-56.67 58.3-107.59 102.04-151.32 43.74-43.74 94.65-78.07 151.32-102.04C623.38 286.58 685.71 274 750 274m0-74c-303.76 0-550 246.24-550 550s246.24 550 550 550 550-246.24 550-550-246.24-550-550-550h0z';
const ARBNOVA_WHITE =
...
export function Arbitrum(props: IconProps) {
  return (
    <svg
...
export function Arbitrum2(props: IconProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
    ...
    >
      ...
      <g fill="#213147">
        ...
        <path d="M162.91 397.79V829c0 27.53 14.71 52.99 38.54 66.71l373.44 215.65a77.17 77.17 0 0 0 77 0l373.44-215.65c23.83-13.72 38.54-39.18 38.54-66.71V397.79c0-27.53-14.71-52.99-38.54-66.71L651.89 115.43a77.17 77.17 0 0 0-77 0L201.36 331.08c-23.83 13.72-38.45 39.18-38.45 66.71z" />
      </g>
      <path d={ARB2_BLUE} fill="#12aaff" />
      <path d={ARB2_BORDER} fill="#9dcced" />
      <path
        d="M346.07 1021.99l37.19-101.82 74.83 62.19-69.96 63.91-42.06-24.28z"
        fill="#213147"
      />
      <path d={ARB2_WHITE} fill="#fff" />
    </svg>
  );
}

export function ArbitrumMono(props: IconProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="262.47 200 975.06 1099.98"
...
export function ArbitrumMono2(props: IconProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 1226.88 1226.88"
    ...
    >
      {props.title && <title>{props.title}</title>}
      <circle cx="613.44" cy="613.44" r="613.44" mask="url(#arbm2-a)" />
      <defs>
        <mask id="arbm2-a">
...
export function ArbitrumOne(props: IconProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="200 228.16 1100 1100"
      width="1em"
      height="1em"
      {...props}
    >
      {props.title && <title>{props.title}</title>}
      <g fill="#1b4add">
        <path d={ARBONE_CIRCLE1} />
        <path d={ARBONE_CIRCLE2} />
      </g>
      <path d={ARBONE_WHITE} fill="#fff" />
    </svg>
  );
}

export function ArbitrumOneMono(props: IconProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="200 228.16 1100 1100"
...
function ArbitrumOne2Base(props: IconProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
...
export function ArbitrumOne2(props: IconProps) {
  return <ArbitrumOne2Base fill="#1b4add" {...props} />;
}

export function ArbitrumOneMono2(props: IconProps) {
  return <ArbitrumOne2Base fill="currentColor" {...props} />;
}

export function ArbitrumNova(props: IconProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="200 200 1100 1100"
    ...
    >
      {props.title && <title>{props.title}</title>}
      <g fill="#e57310">
        <path d={ARBNOVA_CIRCLE1} />
        <path d={ARBNOVA_CIRCLE2} />
      </g>
      <path d={ARBNOVA_WHITE} fill="#fff" />
    </svg>
  );
}

export function ArbitrumNovaMono(props: IconProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="262.47 200 975.06 1099.98"
...
export function ArbitrumNova2Base(props: IconProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="200 200.41 1100 1100"
      width="1em"
      height="1em"
      {...props}
    >
...
export function ArbitrumNova2(props: IconProps) {
  return <ArbitrumNova2Base fill="#e57310" {...props} />;
}

export function ArbitrumNovaMono2(props: IconProps) {
  return <ArbitrumNova2Base fill="currentColor" {...props} />;
}
