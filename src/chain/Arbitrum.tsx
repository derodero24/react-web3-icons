...
export const ArbitrumCircle = createIcon(
  ...
  () => (
    <>
      ...
      <path d={ARB_CIRCLE_BLUE} fill="#12aaff" />
      <path d={ARB_CIRCLE_BORDER} fill="#9dcced" />
      <path
        d="M346.07 1021.99l37.19-101.82 74.83 62.19-69.96 63.91-42.06-24.28z"
        fill="#213147"
      />
      <path d={ARB_CIRCLE_WHITE} fill="#fff" />
    </>
  ),
);
    ...
    <>
      ...
      <defs>
        <mask id={`${_id}-arb-circle-a`}>
          ...
          <g fill="#000">
            <path d={ARB_CIRCLE_BLUE} />
            <path d={ARB_CIRCLE_BORDER} />
            <path d={ARB_CIRCLE_WHITE} />
          </g>
        </mask>
      </defs>
    </>
