  ...
  () => (
    <>
      <circle
        ...
        stroke="#222326"
      />
      <path d={arweavePath} stroke="none" />
    </>
  ),
  '#222326',
);
...
export const ArweaveMono = /* @__PURE__ */ createIcon(
  'ArweaveMono',
  '0 0 31.8 31.8',
  () => (
    <>
