...
export const Ena = createIcon('Ena', '0 0 392 391', () => (
  <>
    <circle cx="196" cy="195.5" r="195.5" fill="#1C1C1C" />
    <path fillRule="evenodd" clipRule="evenodd" fill="#fff" d={enaPath} />
  </>
));

export const EnaMono = createIcon(
  'EnaMono',
  '0 0 392 391',
  () => <path fillRule="evenodd" clipRule="evenodd" d={enaPath} />,
  'currentColor',
);
