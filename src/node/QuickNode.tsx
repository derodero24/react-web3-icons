...
function QuickNodeBase(props: IconProps) {
  return (
    <svg
...
export function QuickNode(props: IconProps) {
  return <QuickNodeBase fill="#00a4d6" {...props} />;
}

export function QuickNodeMono(props: IconProps) {
  return <QuickNodeBase fill="currentColor" {...props} />;
}
